...
//    virtual void ComputeHessionFactor() = 0;
    ...
    void SetInformation(const Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> &information) {
        ...
        // sqrt information
        sqrt_information_ = Eigen::LLT<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>>(information_).matrixL().transpose();
    }
...
protected:
	...
	Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> information_;             // 信息矩阵
	Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> sqrt_information_;
